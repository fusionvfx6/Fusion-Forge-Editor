...
export class ViewportRenderStrategy extends BaseRenderStrategy {
	...
	public override onScrollChanged(e?: ViewScrollChangedEvent): boolean {
		...
		this._device.queue.writeBuffer(this._scrollOffsetBindBuffer, 0, new Float32Array(this._scrollOffsetValueBuffer.buffer, this._scrollOffsetValueBuffer.byteOffset, this._scrollOffsetValueBuffer.length));
		return true;
	}
