...
FusionForge separately records basic usage like the number of messages people are sending. If you'd like to disable FusionForge metrics, you may do so in FusionForge's Settings.
`;
