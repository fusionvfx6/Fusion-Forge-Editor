...
export class ToggleAuxiliaryBarAction extends Action2 {
	...
	static readonly LABEL = localize2('toggleAuxiliaryBar', "Toggle FusionForge Side Bar Visibility");
	...
	constructor() {
		super({
			...
			toggled: {
				...
				title: localize('closeSecondarySideBar', 'Hide FusionForge Side Bar'),
				icon: closeIcon,
			...
			metadata: {
				description: localize('openAndCloseAuxiliaryBar', 'Open/Show and Close/Hide FusionForge Side Bar'),
			},
			f1: true,
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			title: localize2('closeSecondarySideBar', 'Hide FusionForge Side Bar'),
			category: Categories.View,
...
registerAction2(class FocusAuxiliaryBarAction extends Action2 {
	...
	static readonly LABEL = localize2('focusAuxiliaryBar', "Focus into FusionForge Side Bar");
...
MenuRegistry.appendMenuItems([
	{
		...
		item: {
			...
			command: {
				id: ToggleAuxiliaryBarAction.ID,
				title: localize('toggleSecondarySideBar', "Toggle FusionForge Side Bar"),
		...
		item: {
			...
			command: {
				id: ToggleAuxiliaryBarAction.ID,
				title: localize2('hideAuxiliaryBar', 'Hide FusionForge Side Bar'),
			},
...
registerAction2(class extends SwitchCompositeViewAction {
	constructor() {
		super({
			...
			title: localize2('previousAuxiliaryBarView', 'Previous FusionForge Side Bar View'),
			category: Categories.View,
			f1: true
...
registerAction2(class extends SwitchCompositeViewAction {
	constructor() {
		super({
			...
			title: localize2('nextAuxiliaryBarView', 'Next FusionForge Side Bar View'),
			category: Categories.View,
			f1: true
		}, ViewContainerLocation.AuxiliaryBar, 1);
	}
