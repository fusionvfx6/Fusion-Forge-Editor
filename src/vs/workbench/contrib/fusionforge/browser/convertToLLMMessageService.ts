...
class ConvertToLLMMessageService extends Disposable implements IConvertToLLMMessageService {
	...
	constructor(
		...
		@IFusionForgeModelService private readonly voidModelService: IFusionForgeModelService,
	...
	private _getFusionForgeRulesFileContents(): string {
		try {
	...
	private _getCombinedAIInstructions(): string {
		...
		const voidRulesFileContent = this._getFusionForgeRulesFileContents();
