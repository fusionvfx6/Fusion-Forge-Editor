...
import { Diff, DiffArea, FusionForgeFileSnapshot } from '../common/editCodeServiceTypes.js';
...
export interface IEditCodeService {
	...
	// testDiffs(): void;
	getFusionForgeFileSnapshot(uri: URI): FusionForgeFileSnapshot;
	restoreFusionForgeFileSnapshot(uri: URI, snapshot: FusionForgeFileSnapshot): void;
}
