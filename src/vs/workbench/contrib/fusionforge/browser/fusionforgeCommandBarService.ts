...
import { mountFusionForgeCommandBar } from './react/out/fusionforge-editor-widgets-tsx/index.js'
...
export interface IFusionForgeCommandBarService {
...
export const IFusionForgeCommandBarService = createDecorator<IFusionForgeCommandBarService>('FusionForgeCommandBarService');
...
export class FusionForgeCommandBarService extends Disposable implements IFusionForgeCommandBarService {
	_serviceBrand: undefined;

	static readonly ID: 'fusionforge.FusionForgeCommandBarService'
...
registerSingleton(IFusionForgeCommandBarService, FusionForgeCommandBarService, InstantiationType.Delayed); // delayed is needed here :(


export type FusionForgeCommandBarProps = {
	uri: URI | null;
	editor: ICodeEditor;
}
...
class AcceptRejectAllFloatingWidget extends Widget implements IOverlayWidget {
	...
	constructor({ editor }: { editor: ICodeEditor, },
		...
		this.instantiationService.invokeFunction(accessor => {
			...
			const res = mountFusionForgeCommandBar(root, accessor, { uri, editor } satisfies FusionForgeCommandBarProps)
			if (!res) return
			this._register(toDisposable(() => res.dispose?.()))
			this._register(editor.onWillChangeModel((model) => {
				const uri = model.newModelUrl
				res.rerender({ uri, editor } satisfies FusionForgeCommandBarProps)
			}))
		})
	}
...
registerAction2(class extends Action2 {
	...
	async run(accessor: ServicesAccessor): Promise<void> {
		...
		const commandBarService = accessor.get(IFusionForgeCommandBarService);
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			f1: true,
			title: localize2('voidRejectDiffAction', 'FusionForge: Reject Diff'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			f1: true,
			title: localize2('voidGoToNextDiffAction', 'FusionForge: Go to Next Diff'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			f1: true,
			title: localize2('voidGoToPrevDiffAction', 'FusionForge: Go to Previous Diff'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			f1: true,
			title: localize2('voidGoToNextUriAction', 'FusionForge: Go to Next File with Diffs'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			f1: true,
			title: localize2('voidGoToPrevUriAction', 'FusionForge: Go to Previous File with Diffs'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			f1: true,
			title: localize2('voidAcceptFileAction', 'FusionForge: Accept All Diffs in Current File'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			f1: true,
			title: localize2('voidRejectFileAction', 'FusionForge: Reject All Diffs in Current File'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			f1: true,
			title: localize2('voidAcceptAllDiffsAction', 'FusionForge: Accept All Diffs in All Files'),
			keybinding: {
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			f1: true,
			title: localize2('voidRejectAllDiffsAction', 'FusionForge: Reject All Diffs in All Files'),
			keybinding: {
