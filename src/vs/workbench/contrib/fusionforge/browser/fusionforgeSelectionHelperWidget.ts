...
import { mountFusionForgeSelectionHelper } from './react/out/fusionforge-editor-widgets-tsx/index.js';
...
export type FusionForgeSelectionHelperProps = {
...
export class SelectionHelperContribution extends Disposable implements IEditorContribution, IOverlayWidget {
	...
	constructor(
		...
		@IFusionForgeSettingsService private readonly _voidSettingsService: IFusionForgeSettingsService
	) {
		super();
		...
		this._instantiationService.invokeFunction(accessor => {
			...
			const res = mountFusionForgeSelectionHelper(content, accessor);
			if (!res) return;
	...
	private _showHelperForSelection(selection: Selection): void {
		...
		if (enabled) {
			this._rerender({ rerenderKey: this._rerenderKey } satisfies FusionForgeSelectionHelperProps)
