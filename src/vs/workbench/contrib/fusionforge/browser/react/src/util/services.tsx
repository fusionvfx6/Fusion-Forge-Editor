...
import { MCPUserState, RefreshableProviderName, SettingsOfProvider } from '../../../../../../../workbench/contrib/fusionforge/common/voidSettingsTypes.js'
import { DisposableStore, IDisposable } from '../../../../../../../base/common/lifecycle.js'
import { FusionForgeSettingsState } from '../../../../../../../workbench/contrib/fusionforge/common/voidSettingsService.js'
import { ColorScheme } from '../../../../../../../platform/theme/common/theme.js'
import { RefreshModelStateOfProvider } from '../../../../../../../workbench/contrib/fusionforge/common/refreshModelService.js'
...
import { IRefreshModelService } from '../../../../../../../workbench/contrib/fusionforge/common/refreshModelService.js';
import { IFusionForgeSettingsService } from '../../../../../../../workbench/contrib/fusionforge/common/voidSettingsService.js';
import { IExtensionTransferService } from '../../../../../../../workbench/contrib/fusionforge/browser/extensionTransferService.js'
...
let settingsState: FusionForgeSettingsState
const settingsStateListeners: Set<(s: FusionForgeSettingsState) => void> = new Set()
...
export const _registerServices = (accessor: ServicesAccessor) => {
	...
	const stateServices = {
		...
		settingsStateService: accessor.get(IFusionForgeSettingsService),
		refreshModelService: accessor.get(IRefreshModelService),
		themeService: accessor.get(IThemeService),
		editCodeService: accessor.get(IEditCodeService),
		voidCommandBarService: accessor.get(IFusionForgeCommandBarService),
...
const getReactAccessor = (accessor: ServicesAccessor) => {
	const reactAccessor = {
		...
		IFusionForgeSettingsService: accessor.get(IFusionForgeSettingsService),
		...
		IFusionForgeModelService: accessor.get(IFusionForgeModelService),
		IWorkspaceContextService: accessor.get(IWorkspaceContextService),

		IFusionForgeCommandBarService: accessor.get(IFusionForgeCommandBarService),
...
export const useAccessor = () => {
	if (!reactAccessor_) {
		throw new Error(`⚠️ FusionForge useAccessor was called before _registerServices!`)
	}
