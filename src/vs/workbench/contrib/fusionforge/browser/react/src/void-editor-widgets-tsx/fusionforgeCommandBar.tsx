...
import { FusionForgeCommandBarProps } from '../../../voidCommandBarService.js';
...
export const FusionForgeCommandBarMain = ({ uri, editor }: FusionForgeCommandBarProps) => {
	const isDark = useIsDark()

	return <div
		className={`@@fusionforge-scope ${isDark ? 'dark' : ''}`}
	>
		<FusionForgeCommandBar uri={uri} editor={editor} />
	</div>
}
...
export const FusionForgeCommandBar = ({ uri, editor }: FusionForgeCommandBarProps) => {
	...
	const voidModelService = accessor.get('IFusionForgeModelService')
	...
	if (currFileIdx === null) {
		return (
			<div className="pointer-events-auto">
				<div className="flex bg-fusionforge-bg-2 shadow-md border border-fusionforge-border-2 [&>*:first-child]:pl-3 [&>*:last-child]:pr-3 [&>*]:border-r [&>*]:border-fusionforge-border-2 [&>*:last-child]:border-r-0">
		...
		<div className="pointer-events-auto">
			...
			{showAcceptRejectAllButtons && showAcceptRejectAll && (
				<div className="flex justify-end mb-1">
					<div className="inline-flex bg-fusionforge-bg-2 rounded shadow-md border border-fusionforge-border-2 overflow-hidden">
						<div className="flex items-center [&>*]:border-r [&>*]:border-fusionforge-border-2 [&>*:last-child]:border-r-0">
			...
			<div className="flex items-center bg-fusionforge-bg-2 rounded shadow-md border border-fusionforge-border-2 [&>*:first-child]:pl-3 [&>*:last-child]:pr-3 [&>*]:px-3 [&>*]:border-r [&>*]:border-fusionforge-border-2 [&>*:last-child]:border-r-0">
