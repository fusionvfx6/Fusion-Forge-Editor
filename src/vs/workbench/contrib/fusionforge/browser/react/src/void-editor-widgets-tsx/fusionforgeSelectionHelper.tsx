...
import { FusionForgeSelectionHelperProps } from '../../../../../../contrib/fusionforge/browser/voidSelectionHelperWidget.js';
import { VOID_OPEN_SETTINGS_ACTION_ID } from '../../../voidSettingsPane.js';


export const FusionForgeSelectionHelperMain = (props: FusionForgeSelectionHelperProps) => {
	...
	>
		<FusionForgeSelectionHelper {...props} />
	</div>
}



const FusionForgeSelectionHelper = ({ rerenderKey }: FusionForgeSelectionHelperProps) => {
	...
	const dividerHTML = <div className='w-[0.5px] bg-fusionforge-border-3'></div>
	...
	return <div className='
		...
		border border-fusionforge-border-3 bg-fusionforge-bg-2
