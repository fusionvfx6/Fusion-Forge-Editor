	...
	theme: {
		extend: {
			typography: theme => ({
				DEFAULT: {
					css: {
						'--tw-prose-body': 'var(--fusionforge-fg-1)',
						'--tw-prose-headings': 'var(--fusionforge-fg-1)',
						'--tw-prose-lead': 'var(--fusionforge-fg-2)',
						'--tw-prose-links': 'var(--fusionforge-link-color)',
						'--tw-prose-bold': 'var(--fusionforge-fg-1)',
						'--tw-prose-counters': 'var(--fusionforge-fg-3)',
						'--tw-prose-bullets': 'var(--fusionforge-fg-3)',
						'--tw-prose-hr': 'var(--fusionforge-border-4)',
						'--tw-prose-quotes': 'var(--fusionforge-fg-1)',
						'--tw-prose-quote-borders': 'var(--fusionforge-border-2)',
						'--tw-prose-captions': 'var(--fusionforge-fg-3)',
						'--tw-prose-code': 'var(--fusionforge-fg-0)',
						'--tw-prose-pre-code': 'var(--fusionforge-fg-0)',
						'--tw-prose-pre-bg': 'var(--fusionforge-bg-1)',
						'--tw-prose-th-borders': 'var(--fusionforge-border-4)',
						'--tw-prose-td-borders': 'var(--fusionforge-border-4)',
					},
				},
			}),
			fontSize: {
			...
			colors: {
				'fusionforge-bg-1': 'var(--fusionforge-bg-1)',
				'fusionforge-bg-1-alt': 'var(--fusionforge-bg-1-alt)',
				'fusionforge-bg-2': 'var(--fusionforge-bg-2)',
				'fusionforge-bg-2-alt': 'var(--fusionforge-bg-2-alt)',
				'fusionforge-bg-2-hover': 'var(--fusionforge-bg-2-hover)',
				'fusionforge-bg-3': 'var(--fusionforge-bg-3)',


				'fusionforge-fg-0': 'var(--fusionforge-fg-0)',
				'fusionforge-fg-1': 'var(--fusionforge-fg-1)',
				'fusionforge-fg-2': 'var(--fusionforge-fg-2)',
				'fusionforge-fg-3': 'var(--fusionforge-fg-3)',
				// 'fusionforge-fg-4': 'var(--vscode-tab-inactiveForeground)',
				'fusionforge-fg-4': 'var(--fusionforge-fg-4)',

				'fusionforge-warning': 'var(--fusionforge-warning)',

				'fusionforge-border-1': 'var(--fusionforge-border-1)',
				'fusionforge-border-2': 'var(--fusionforge-border-2)',
				'fusionforge-border-3': 'var(--fusionforge-border-3)',
				'fusionforge-border-4': 'var(--fusionforge-border-4)',

				'fusionforge-ring-color': 'var(--fusionforge-ring-color)',
				'fusionforge-link-color': 'var(--fusionforge-link-color)',
