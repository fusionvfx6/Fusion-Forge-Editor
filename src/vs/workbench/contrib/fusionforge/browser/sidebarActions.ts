...
const VOID_OPEN_SIDEBAR_ACTION_ID = 'fusionforge.sidebar.open'
registerAction2(class extends Action2 {
	constructor() {
		super({ id: VOID_OPEN_SIDEBAR_ACTION_ID, title: localize2('voidOpenSidebar', 'FusionForge: Open Sidebar'), f1: true });
	}
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			...
			f1: true,
			title: localize2('voidCmdL', 'FusionForge: Add Selection to Chat'),
			keybinding: {
...
const VOID_CMD_SHIFT_L_ACTION_ID = 'fusionforge.cmdShiftL'
registerAction2(class extends Action2 {
	constructor() {
		super({
...
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: 'fusionforge.settingsAction',
			title: `FusionForge's Settings`,
