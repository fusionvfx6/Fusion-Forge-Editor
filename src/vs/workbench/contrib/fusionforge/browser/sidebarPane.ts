...
// const voidViewIcon = registerIcon('fusionforge-view-icon', voidThemeIcon, localize('voidViewIcon', 'View icon of the FusionForge chat view.'));
...
const container = viewContainerRegistry.registerViewContainer({
	...
	title: nls.localize2('voidContainer', 'Chat'), // this is used to say "FusionForge" (Ctrl + L)
...
// open sidebar
export const VOID_OPEN_SIDEBAR_ACTION_ID = 'fusionforge.openSidebar'
registerAction2(class extends Action2 {
	constructor() {
		super({
			id: VOID_OPEN_SIDEBAR_ACTION_ID,
			title: 'Open FusionForge Sidebar',
		})
	}
...
export class SidebarStartContribution implements IWorkbenchContribution {
	static readonly ID = 'workbench.contrib.startupFusionForgeSidebar';
	constructor(
