...
export class ToolsService implements IToolsService {
	...
	constructor(
		...
		@IFusionForgeModelService voidModelService: IFusionForgeModelService,
		@IEditCodeService editCodeService: IEditCodeService,
		@ITerminalToolService private readonly terminalToolService: ITerminalToolService,
		@IFusionForgeCommandBarService private readonly commandBarService: IFusionForgeCommandBarService,
		...
		this.stringOfResult = {
			...
			run_command: (params, result) => {
				...
				if (resolveReason.type === 'timeout') {
					return `${result_}\nTerminal command ran, but was automatically killed by FusionForge after ${MAX_TERMINAL_INACTIVE_TIME}s of inactivity and did not finish successfully. To try with more time, open a persistent terminal and run the command there.`
				}
