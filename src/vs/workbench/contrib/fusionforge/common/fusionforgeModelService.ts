...
type FusionForgeModelType = {
	model: ITextModel | null;
	editorModel: IResolvedTextEditorModel | null;
};

export interface IFusionForgeModelService {
	readonly _serviceBrand: undefined;
	initializeModel(uri: URI): Promise<void>;
	getModel(uri: URI): FusionForgeModelType;
	getModelFromFsPath(fsPath: string): FusionForgeModelType;
	getModelSafe(uri: URI): Promise<FusionForgeModelType>;
	saveModel(uri: URI): Promise<void>;

}

export const IFusionForgeModelService = createDecorator<IFusionForgeModelService>('voidFusionForgeModelService');

class FusionForgeModelService extends Disposable implements IFusionForgeModelService {
	_serviceBrand: undefined;
	static readonly ID = 'voidFusionForgeModelService';
	...
	getModelSafe = async (uri: URI): Promise<FusionForgeModelType> => {
...
registerSingleton(IFusionForgeModelService, FusionForgeModelService, InstantiationType.Eager);
