...
import { FusionForgeSettingsState } from './voidSettingsService.js'
...
export type FusionForgeStatefulModelInfo = { // <-- STATEFUL
	modelName: string,
...
type CommonProviderSettings = {
	...
	models: FusionForgeStatefulModelInfo[],
}
...
export const subTextMdOfProviderName = (providerName: ProviderName): string => {
	...
	if (providerName === 'googleVertex') return 'You must authenticate before using Vertex with FusionForge. Read more about endpoints [here](https://cloud.google.com/vertex-ai/generative-ai/docs/multimodal/call-vertex-using-openai-library), and regions [here](https://cloud.google.com/vertex-ai/docs/general/locations#available-regions).'
...
const modelInfoOfDefaultModelNames = (defaultModelNames: string[]): { models: FusionForgeStatefulModelInfo[] } => {
	return {
...
export const isProviderNameDisabled = (providerName: ProviderName, settingsState: FusionForgeSettingsState) => {
...
export const isFeatureNameDisabled = (featureName: FeatureName, settingsState: FusionForgeSettingsState) => {
