...
// gets converted to --vscode-fusionforge-greenBG, see fusionforge.css, asCssVariable
registerColor('fusionforge.greenBG', configOfBG(acceptBG), '', true);
registerColor('fusionforge.redBG', configOfBG(rejectBG), '', true);
registerColor('fusionforge.sweepBG', configOfBG(sweepBG), '', true);
registerColor('fusionforge.highlightBG', configOfBG(highlightBG), '', true);
registerColor('fusionforge.sweepIdxBG', configOfBG(sweepIdxBG), '', true);
