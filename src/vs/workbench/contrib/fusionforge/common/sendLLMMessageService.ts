...
import { IFusionForgeSettingsService } from './voidSettingsService.js';
...
export class LLMMessageService extends Disposable implements ILLMMessageService {
	...
	constructor(
		...
		// const service = ProxyChannel.toService<LLMMessageChannel>(mainProcessService.getChannel('fusionforge-channel-sendLLMMessage')); // lets you call it like a service
		// see llmMessageChannel.ts
		this.channel = this.mainProcessService.getChannel('fusionforge-channel-llmMessage')
	...
	sendLLMMessage(params: ServiceSendLLMMessageParams) {
		...
		if (modelSelection === null) {
			const message = `Please add a provider in FusionForge's Settings.`
