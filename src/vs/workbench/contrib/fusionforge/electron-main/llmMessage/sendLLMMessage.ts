...
export const sendLLMMessage = async ({
	...
	const onError: OnError = ({ message: errorMessage, fullError }) => {
		...
		if (errorMessage === 'TypeError: fetch failed')
			errorMessage = `Failed to fetch from ${displayInfoOfProviderName(providerName).title}. This likely means you specified the wrong endpoint in FusionForge's Settings, or your local model provider like Ollama is powered off.`
