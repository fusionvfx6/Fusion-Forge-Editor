...
const SimpleModelSettingsDialog = ({
	...
	const sourcecodeOverridesLink = `https://github.com/fusionvfx6/Fusion-Forge-Editor/blob/main/src/vs/workbench/contrib/void/common/modelCapabilities.ts#L146-L172`
