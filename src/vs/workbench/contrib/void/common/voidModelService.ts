...
class FusionForgeModelService extends Disposable implements IVoidModelService {
...
registerSingleton(IVoidModelService, FusionForgeModelService, InstantiationType.Eager);
