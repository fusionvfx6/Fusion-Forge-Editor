...
class FusionForgeSettingsService extends Disposable implements IVoidSettingsService {
...
registerSingleton(IVoidSettingsService, FusionForgeSettingsService, InstantiationType.Eager);
