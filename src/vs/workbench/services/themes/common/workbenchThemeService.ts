...
export enum ThemeSettingDefaults {
	COLOR_THEME_DARK = 'Default Dark+', // FusionForge changed this from 'Default Dark Modern'
	COLOR_THEME_LIGHT = 'Default Light Modern',
	COLOR_THEME_HC_DARK = 'Default High Contrast',
	COLOR_THEME_HC_LIGHT = 'Default High Contrast Light',

	COLOR_THEME_DARK_OLD = 'Default Dark Modern', // FusionForge changed this from 'Default Dark+'
...
export const COLOR_THEME_DARK_INITIAL_COLORS = { // FusionForge changed this to match dark+
